...
map("n", "<leader>[", "<cmd>Telescope treesitter<CR>", { desc = "Find symbol in treesitter syntax tree using Telescope" })
map("n", "<leader>]", "<cmd>Telescope lsp_definitions<CR>", { desc = "Jump to hovered word definition using Telescope" })
map(
    "n",
    "<leader>f",
